...
object Statement:
  ...
  object `def`:
    ...
    object `0`:
      ...
      case class `[_[_]]`[F[_], A](tparam: `Type: x_x`[F], impl: Option[`Value: x`[A]], value: `Value.Var`[A]) extends Statement
      case class `[_[_], _]`[F[_], A, T](tparamf: `Type: x_x`[F], tparama: `Type: x`[A], impl: Option[`Value: x`[T]], value: `Value.Var`[T]) extends Statement
    ...
    object `1`:
      ...
      case class `[_[_], _]`[F[_], T, A, B](tparamf: `Type: x_x`[F], tparama: `Type: x`[A], arg: `Value: x`[A], ret: `Type: x`[B], impl: Option[`Value: x`[T]], value: `Value.Var`[T]) extends Statement
  ...
  object `trait`:
    case class `[_]`[T[_], A](tpe: `Type.Var: x_x`[T], tparam: `Type: x`[A], parent: Option[Type], body: List[Statement]) extends Statement
    case class `[_[_]]`[T[_[_]], F[_]](tpe: `Type.Var: lx_xl_x`[T], tparam: `Type: x_x`[F], parent: Option[Type], body: List[Statement]) extends Statement
    case class `[_[_], _]`[T[_[_], _], F[_], A](tpe: `Type.Var: lx_xl_x_x`[T], tparamf: `Type: x_x`[F], tparama: `Type: x`[A], parent: Option[Type], body: List[Statement]) extends Statement
  case class `type`[T](tpe: `Type.Var: x`[T]) extends Statement
  object `type`:
    case class `[_]`[F[_], A](tparam: `Type: x`[A], tpe: `Type.Var: x_x`[F]) extends Statement
    case class `[_]=>>`[F[_]](tpe: `Type.Var: x_x`[F]) extends Statement
    case class `[_[_]]`[F[_[_]], G[_]](tparam: `Type: x_x`[G], tpe: `Type.Var: lx_xl_x`[F]) extends Statement
    case class `[_[_], _]`[F[_[_], _], G[_], A](tparamf: `Type: x_x`[G], tparama: `Type: x`[A], tpe: `Type.Var: lx_xl_x_x`[F]) extends Statement

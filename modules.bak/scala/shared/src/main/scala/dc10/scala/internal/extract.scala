  ...
  extension [A] (v: `Value: x`[A])
    def unapply[B]: Either[List[Error], `Value: x`[B]] =
      v match
        ...
        case `Value.App.Vargs: x`(in, fun, tpe, vargsx) => Left(List(Error(s"Value in not a construction ${v}")))
        ...
        case `Value.AppForComp: x→x x`(in, gens, ret, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
        case `Value.App.Match`(in, value, tpe, cases) => Left(List(Error(s"Value in not a construction ${v}")))
        case `Value.App.0: x→x`(in, fun, targ, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
        case `Value.App.0: (x→x)→x→x`(in, fun, targf, targa, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
        case `Value.App.0: (x→x)→x→x`(in, fun, targf, targa, targb, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
        ...
        case `Value.Lam.1: x→x→x x x`(in, a, b, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
        case `Value.Lam.2: x→x→x→x x * x`(in, a1, a2, r, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
        case `Value.Lam.3: x→x→x→x→x x * x x`(in, a1, a2, a3, r, tpe) => Left(List(Error(s"Value in not a construction ${v}")))
  ...
  extension [F[_], A] (v: `Value: x`[F[A]])
    def unpure: Either[List[Error], `Value: x`[A]] =
      v match
        ...
        case `Value.App.Vargs: x`(in, fun, tpe, vargsx) => Left(List(Error(s"not a FlatMap value ${v}")))
        ...
        case `Value.AppForComp: x→x x`(in, gens, ret, tpe) => Left(List(Error(s"not a FlatMap value ${v}")))
        case `Value.App.Match`(in, value, tpe, cases) => Left(List(Error(s"not a FlatMap value ${v}")))
        case `Value.App.0: x→x`(in, fun, targ, tpe) => Left(List(Error(s"not a FlatMap value ${v}")))
        case `Value.App.0: (x→x)→x→x`(in, fun, targf, targa, tpe) => Left(List(Error(s"not a FlatMap value ${v}")))
        case `Value.App.0: (x→x)→x→x`(in, fun, targf, targa, targb, tpe) => Left(List(Error(s"not a FlatMap value ${v}")))
        ...
        case `Value.Lam.1: x→x→x x x`(in, a, b, tpe) => Right(b.asInstanceOf[`Value: x`[A]])
        case `Value.Lam.2: x→x→x→x x * x`(in, a1, a2, c, tpe) => Left(List(Error(s"not a FlatMap value ${v}")))
        case `Value.Lam.3: x→x→x→x→x x * x x`(in, a1, a2, a3, r, tpe) => Left(List(Error(s"not a FlatMap value ${v}")))

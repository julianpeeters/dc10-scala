...
case class `Value.App.1: *`[A, B](lvl: Int, fun: `Value: *`[A => B], arg: `Value: *`[A], tpe: `Type: *`[B]) extends `Value.Expr: *`[B]
case class `Value.App.2: *`[A, B, C](lvl: Int, fun: `Value: *`[(A, B) => C], arg1: `Value: *`[A], arg2: `Value: *`[B], tpe: `Type: *`[C]) extends `Value.Expr: *`[C]
case class `Value.App.3: *`[A, B, C, D](lvl: Int, fun: `Value: *`[(A, B, C) => D], arg1: `Value: *`[A], arg2: `Value: *`[B], arg3: `Value: *`[C], tpe: `Type: *`[D]) extends `Value.Expr: *`[D]
case class `Value.AppDot.0: *`[A, B](lvl: Int, fun: `Value: *`[A => B], arg1: `Value: *`[A], tpe: `Type: *`[B]) extends `Value.Expr: *`[B]
case class `Value.AppDot.1: *`[A, B, C, D](lvl: Int, fun: `Value: *`[D], arg1: `Value: *`[A], arg2: `Value: *`[B], tpe: `Type: *`[C]) extends `Value.Expr: *`[C]
case class `Value.AppDotless: *`[A, B, C, D](lvl: Int, fun: `Value: *`[D], arg1: `Value: *`[A], arg2: `Value: *`[B], tpe: `Type: *`[C]) extends `Value.Expr: *`[C]
case class `Value.App.0: *→*`[G[_], A, B](lvl: Int, fun: `Value: *→*`[G], targ: `Type: *`[A], tpe: `Type: *`[B]) extends `Value.Expr: *`[B]
case class `Value.App.0: (*→*)→*→*`[G[_[_], _], H[_], A, B](lvl: Int, fun: `Value: (*→*)→*→*`[G], targf: `Type: *→*`[H], targa: `Type: *`[A], tpe: `Type: *`[B]) extends `Value.Expr: *`[B]
case class `Value.App.0: (*→*)→*→*→*`[G[_[_], _, _], H[_], A, B, C](lvl: Int, fun: `Value: (*→*)→*→*→*`[G], targf: `Type: *→*`[H], targa: `Type: *`[A], targb: `Type: *`[B], tpe: `Type: *`[C]) extends `Value.Expr: *`[C]
case class `Value.App.Vargs: *`[A, B](lvl: Int, fun: `Value: *`[List[A] => B], tpe: `Type: *`[B], vargs: `Value: *`[A]*) extends `Value.Expr: *`[B]
case class `Value.Def.0: *`[T](lvl: Int, sym: `DefSym.0`, tpe: `Type: *`[T], impl: Option[`Value: *`[T]]) extends `Value.Expr: *`[T]
case class `Value.Lit.Boolean: *`(lvl: Int, tpe: `Type: *`[Boolean], b: Boolean) extends `Value.Expr: *`[Boolean]
case class `Value.Lit.Int: *`(lvl: Int, tpe: `Type: *`[Int], i: Int) extends `Value.Expr: *`[Int]
case class `Value.Lit.Long: *`(lvl: Int, tpe: `Type: *`[Long], l: Long) extends `Value.Expr: *`[Long]
case class `Value.Lit.Float: *`(lvl: Int, tpe: `Type: *`[Float], f: Float) extends `Value.Expr: *`[Float]
case class `Value.Lit.Double: *`(lvl: Int, tpe: `Type: *`[Double], d: Double) extends `Value.Expr: *`[Double]
case class `Value.Lit.String: *`(lvl: Int, tpe: `Type: *`[String], s: String) extends `Value.Expr: *`[String]
case class `Value.Lit.Unit: *`(lvl: Int, tpe: `Type: *`[Unit], u: Unit) extends `Value.Expr: *`[Unit]
case class `Value.Obj: *`[T](lvl: Int, sym: ObjSym, tpe: `Type: *`[T], parent: Option[`Type: *`[T]], body: List[Statement]) extends `Value.Expr: *`[T]
case class `Value.Val: *`[T](lvl: Int, sym: ValSym, tpe: `Type: *`[T], impl: Option[`Value: *`[T]]) extends `Value.Expr: *`[T]
...
sealed trait `Value.Expr: *→*→*→*→* * * * *`[F[_, _, _, _], A, B, C, D] extends `Value.Expr: *`[F[A, B, C, D]]:

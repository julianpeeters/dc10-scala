  ...
  object Term:
    ...
    object TypeLevel:
      ...
      object App:
        ...
        case class App1T[T[_[_], _], F[_], A, W, X, Y, Z](qnt: Option[Long], tfun: TypeLevel[T[F, A], W], farg: TypeLevel[F[A], X], aarg: TypeLevel[A, Y],  dep: ValueLevel[Z, Any]) extends App[T[F, A], Z]
